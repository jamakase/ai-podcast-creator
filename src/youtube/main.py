...
def run():
    ...
    """
    inputs = {
        'pdf_url': 'https://www.b2bmarketingworld.com/wp-content/uploads/Marketing-Strategy-for-B2B.pdf',
    }
...
def test():
    ...
    try:
        Youtube().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
